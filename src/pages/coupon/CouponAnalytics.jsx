  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        ...
        const summaryResponse = await apiService.get(`/deals/analytics/${id}`);
        setSummaryAnalyticsData(summaryResponse.data);
      } catch (error) {
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }} elevation={3}>
            ...
            <Typography variant="h3">{summaryAnalyticsData.views}</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }} elevation={3}>
            ...
            <Typography variant="h3">{summaryAnalyticsData.opens}</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }} elevation={3}>
            ...
            <Typography variant="h3">{summaryAnalyticsData.shares}</Typography>
          </Paper>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }} elevation={3}>
            ...
            <Typography variant="h3">
              {summaryAnalyticsData.totalMoneySpent}
            </Typography>
          </Paper>
        </Grid>
