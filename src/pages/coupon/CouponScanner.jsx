...
import { QrCode as QrCodeIcon, ArrowBack as ArrowBackIcon, TextFields as TextFieldsIcon, Close as CloseIcon, Store, Category, CalendarToday, Person, Phone, Email, Facebook, Instagram, Twitter, YouTube, LinkedIn } from '@mui/icons-material';
                                    ...
                                    <Box>
                                        ...
                                        <Stack spacing={2}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                ...
                                                <Box>
                                                    <Typography variant="subtitle2" color="text.secondary">Shop</Typography>
                                                    <Typography variant="body1">{couponDetails.deal.shop.name}</Typography>
                                                </Box>
                                            </Box>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                <Avatar sx={{ bgcolor: alpha(theme.palette.primary.main, 0.1) }}>
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="body1">{couponDetails.deal.shop.category.name}</Typography>
                                                </Box>
                                            </Box>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                <Avatar sx={{ bgcolor: alpha(theme.palette.primary.main, 0.1) }}>
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="body1">
                                                        {new Date(couponDetails.deal.availableUntil).toLocaleDateString()}
                                                    </Typography>
                                                </Box>
                                            </Box>
                                        </Stack>
                                        ...
                                        <Stack spacing={2}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="body1">{couponDetails.user.name}</Typography>
                                                </Box>
                                            </Box>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                <Avatar sx={{ bgcolor: alpha(theme.palette.info.main, 0.1) }}>
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="body1">{couponDetails.user.phone}</Typography>
                                                </Box>
                                            </Box>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                <Avatar sx={{ bgcolor: alpha(theme.palette.info.main, 0.1) }}>
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="body1">{couponDetails.user.email}</Typography>
                                                </Box>
                                            </Box>
                                        </Stack>
                                    </Box>
