...
const RedeemedCouponDetails = () => {
    ...
    if (!redemption) {
        return (
            <Box sx={{ p: 3 }}>
                <Typography variant="h5" color="error">Failed to load redemption details</Typography>
            </Box>
        );
    }
                        ...
                        <CardContent sx={{ p: 4 }}>
                            <Stack spacing={3}>
                                ...
                                <Stack direction="row" spacing={2} flexWrap="wrap">
                                    ...
                                    <Chip
                                        icon={<CalendarIcon />}
                                        label={`Valid until: ${format(new Date(redemption.deal.availableUntil), 'PP')}`}
                                        variant="outlined"
                                        sx={{ borderRadius: '12px' }}
                                    />
                                    <Chip
                                        icon={redemption.used ? <CheckCircleIcon /> : <PendingIcon />}
                                        ...
                                        sx={{
                                            ...
                                            border: `1px solid ${redemption.used
                                                ? theme.palette.success.main
                                                : theme.palette.warning.main}`,
                                            fontWeight: 600,
